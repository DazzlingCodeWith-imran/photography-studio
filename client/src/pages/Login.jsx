...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-800 dark:to-gray-900 pt-20 pb-16 px-4">
      {/* SEO Meta Tags */}
      <Helmet>
        <title>PhotoStudio - Login</title>
        <meta name="description" content="Login to your PhotoStudio account to book sessions and access exclusive features." />
        <meta name="keywords" content="login, photostudio, photography, videography, Mumbai" />
      </Helmet>
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-blue-900/80 to-purple-900/80 dark:from-gray-900/80 dark:to-gray-800/80 flex items-center justify-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              <span className="text-amber-400 dark:text-yellow-400">Login</span> to Your Account
            </h1>
            <p className="text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
              Access your PhotoStudio account to book sessions and manage your bookings.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="max-w-md mx-auto px-4 py-12 -mt-16 z-10 relative">
        ...
        >
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-200 mb-6">Sign In</h2>
          ...
          <p className="mt-4 text-center text-gray-600 dark:text-gray-300">
            ...
            <Link to="/register" className="text-blue-600 dark:text-yellow-400 hover:underline">
              Register
            </Link>
          </p>
        </motion.div>
        ...
        {showSuccess && (
          <motion.div
            ...
            aria-label="Login success modal"
          >
            <motion.div
            ...
            >
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-200 mb-4">Login Successful!</h2>
